...
export default {
  ...
  mounted() {
    // this.html = <div>Hello Aleko you made it work!</div>
    console.log(`archive.vue - 8 - archive page works`);
  },
  methods: {
    goToStaticPage() {
      this.$router.push("/html/newsletter.html");
      console.log(`archive.vue - 24 - 😊`);
    },
    showMe(data) {
      console.log(`archive.vue - 76 - 🌊`, data);
    },
    openGithub(url) {
      window.open(url);
    }
